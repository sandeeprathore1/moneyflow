"""phase 2 tables income_sources recurring_transactions user_preferences audit_logs
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_recurring_transactions_user_id"), "recurring_transactions", ["user_id"], unique=False
    )
